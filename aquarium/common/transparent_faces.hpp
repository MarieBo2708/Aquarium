...
class transparentFaces{
    ...
    GLuint normalsbuffertransparent;

    transparentFaces();
    void generateVertices();
    void generateIndices();
    void generateNormals();
    void generateBuffers(std::vector<glm::vec3> vertices, std::vector<unsigned short> indices, std::vector<glm::vec3> normals);
    void drawFaces(GLuint programID, bool clip, glm::vec4 clipPlane);
    void disableArrays();
    void deleteBuffers();
