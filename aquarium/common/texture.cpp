...
{	
	...
	// }
	UVs.push_back(glm::vec2((vertices[5].z - min)/(max - min), (vertices[5].y - min)/(max - min)));
	UVs.push_back(glm::vec2((vertices[3].z - min)/(max - min), (vertices[3].y - min)/(max - min)));
	UVs.push_back(glm::vec2((vertices[2].z - min)/(max - min), (vertices[2].y - min)/(max - min)));
	UVs.push_back(glm::vec2((vertices[4].z - min)/(max - min), (vertices[4].y - min)/(max - min)));
	
	UVs.push_back(glm::vec2((vertices[9].x - min)/(max - min), (vertices[9].z - min)/(max - min)));
	UVs.push_back(glm::vec2((vertices[8].x - min)/(max - min), (vertices[8].z - min)/(max - min)));
	UVs.push_back(glm::vec2((vertices[7].x - min)/(max - min), (vertices[7].z - min)/(max - min)));
